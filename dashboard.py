...
class IMS():
    def __init__(self,root):
        ...
        self.root=root
        self.root.geometry("1530x1100+0+0")
        # self.root.setGeometry=(250, 120, 1280, 1024)
        self.root.title("Invertory Management System | Developed by Star Techies")
        self.root.config(bg="white")

        # title
        self.icon_title=PhotoImage(file="images/logo1.png")
        title=Label(self.root,text="MegaVentory",image=self.icon_title,compound =LEFT,font=("times new roman",40,"bold"),bg="#010c48",fg="white",anchor="w",padx=20).place(x=0,y=0,relwidth=1,height=70)
        ...
        self.MenuLogo=self.MenuLogo.resize((200,200),Image.LANCZOS)      #ANTIALIAS for good quality even size changes
        ...
        # footer
        lbl_footer=Label(self.root,text="MegaVentor | Develop by Star Techies",font=("times new roman",15),bg="#4d636d",fg="white")
