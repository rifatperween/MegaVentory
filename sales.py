...
class salesClass:
    def __init__(self, root):
        ...
        self.root.title(
            "Invertory Management System | Developed by Star Techies")
...
# title===========
        ...
        btn_search = Button(self.root, text="Search", command=self.search,font=("times new roman", 15, "bold"), bg="#2196f3", fg="white", cursor="hand2").place(x=360, y=100, width=120, height=20)
        btn_clear = Button(self.root, text="Clear", command=self.clear,font=("times new roman", 15, "bold"), bg="lightgray", cursor="hand2").place(x=490, y=100, width=120, height=20)
...
# Image=============
        ...
        # ANTIALIAS for good quality even size changes
